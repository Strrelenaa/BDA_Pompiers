...
def load_data():
    ...
    df_mob_1520 = pd.read_csv("LFB Mobilisation data from 2015 - 2020.zip", compression='zip', encoding='ISO-8859-1', sep=';', on_bad_lines='skip')
    df_mob_2124 = pd.read_csv("LFB Mobilisation data 2021 - 2024.zip", compression='zip', encoding='ISO-8859-1', sep=';')
